...
public class DBInfo {
	...
	public static class 섭취정보계산 {
		...
		public final static String mf_date="섭취일자";
		public final static String mf_fcode="식품코드";
		public final static String mf_name="식품명";
		public final static String mf_amt="섭취량";
		public final static String mf_once="제공량";
		public final static String mf_capa="총내용량";
		public final static String mf_cal="에너지";
		public final static String mf_protein="단백질";
		public final static String mf_fat="지방";
		public final static String mf_carbo="탄수화물";
		public final static String mf_sugar="총당류";
	}
